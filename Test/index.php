...
html> <html lang="fa"> <head>
    ...
    تسک‌ها</title> <style>
        ...
        th, td { padding: 15px; border: 1px solid 
            #ddd;
            text-align: left;
        }
        th { background-color: #0056b3; color: 
            white;
        }
